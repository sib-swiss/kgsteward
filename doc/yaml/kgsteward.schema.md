...
This file is autogenerated with the command `uv run make_YAML_README.py` - manual modifications will be lost!
...
Markdown generated with [jsonschema-markdown](https://github.com/elisiariocouto/jsonschema-markdown) 0.2.1 on 2024-12-19 10:56:55.
