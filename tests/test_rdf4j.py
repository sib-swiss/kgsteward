...
#     res_init = run_cmd(["kgsteward", "example/first_steps/first_steps_rdf4j.yaml", "-I"], env)
#     print(res_init.stdout)
#     assert res_init.returncode == 0

#     res_complete = run_cmd(["kgsteward", "example/first_steps/first_steps_rdf4j.yaml", "-C"], env)
#     print(res_complete.stdout)
#     assert res_complete.returncode == 0

#     res_validate = run_cmd(["kgsteward", "example/first_steps/first_steps_rdf4j.yaml", "-V"], env)
